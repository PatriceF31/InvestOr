// scripts/verify-morpho-yield-strategy.ts
//
// Vérifications en lecture seule après déploiement, AVANT de proposer la
// transaction Safe sur Reserve. Ne modifie rien on-chain.
//
// Usage :
//   npx hardhat run scripts/verify-morpho-yield-strategy.ts --network sepolia

import { network } from "hardhat";

const ORACLE_ADDRESS   = "0xb3931fF80Da38CB80E4CA5e31cf91C6c57bD0F5d";
const STRATEGY_ADDRESS = "0x81C8904C4300C771F2752f7B56F2feEbAcde0570";
...
async function main() {
  ...
  // Convention Morpho : price = valeur de 1 unité de base (cbBTC, 8 déc) en
